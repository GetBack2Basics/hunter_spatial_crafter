#!/usr/bin/env python3
"""
Clean, robust builder for runner/build_suitability_report.py and runner/national_suitability_report.html
Preserves the full Leaflet map, all GeoJSON layers, all 10 tabs, search bar, and 4-factor simulation sliders.
"""
...
# 1. Load GeoJSON layers and base candidates from the working HTML
def load_source_layers():
    ...
    return precinct_geojson, net_developable_geojson, pipelines_geojson, rail_geojson, biodiversity_geojson

# 2. Build multi-jurisdiction candidates (17 candidates across all 8 Australian jurisdictions)
def get_authoritative_candidates():
    ...
    return candidates, state_list, region_list

print("Loaded helper modules successfully.")
